...
public class ItemsServiceApi {
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Item-Information.html">Gets items based on a query. Documentation</a>
     */
    public QueryResultBaseItemRespDto getItems(QueryResultBaseItemReqDto reqDto) throws ApiException {
        ApiResponse<QueryResultBaseItemRespDto> resp = getItemsWithHttpInfo(reqDto);
        return resp.getData();
    }
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Item-Information.html">Gets items based on a query. Documentation</a>
     */
    public ApiResponse<QueryResultBaseItemRespDto> getItemsWithHttpInfo(QueryResultBaseItemReqDto reqDto) throws ApiException {
        com.squareup.okhttp.Call call = getItemsValidateBeforeCall(reqDto.getArtistType(),
                reqDto.getMaxOfficialRating(),
                reqDto.getHasThemeSong(),
                reqDto.getHasThemeVideo(),
                reqDto.getHasSubtitles(),
                reqDto.getHasSpecialFeature(),
                reqDto.getHasTrailer(),
                reqDto.getAdjacentTo(),
                reqDto.getMinIndexNumber(),
                reqDto.getMinStartDate(),
                reqDto.getMaxStartDate(),
                reqDto.getMinEndDate(),
                reqDto.getMaxEndDate(),
                reqDto.getMinPlayers(),
                reqDto.getMaxPlayers(),
                reqDto.getParentIndexNumber(),
                reqDto.getHasParentalRating(),
                reqDto.getIsHD(),
                reqDto.getIsUnaired(),
                reqDto.getMinCommunityRating(),
                reqDto.getMinCriticRating(),
                reqDto.getAiredDuringSeason(),
                reqDto.getMinPremiereDate(),
                reqDto.getMinDateLastSaved(),
                reqDto.getMinDateLastSavedForUser(),
                reqDto.getMaxPremiereDate(),
                reqDto.getHasOverview(),
                reqDto.getHasImdbId(),
                reqDto.getHasTmdbId(),
                reqDto.getHasTvdbId(),
                reqDto.getExcludeItemIds(),
                reqDto.getStartIndex(),
                reqDto.getLimit(),
                reqDto.getRecursive(),
                reqDto.getSearchTerm(),
                reqDto.getSortOrder(),
                reqDto.getParentId(),
                reqDto.getFields(),
                reqDto.getExcludeItemTypes(),
                reqDto.getIncludeItemTypes(),
                reqDto.getAnyProviderIdEquals(),
                reqDto.getFilters(),
                reqDto.getIsFavorite(),
                reqDto.getIsMovie(),
                reqDto.getIsSeries(),
                reqDto.getIsFolder(),
                reqDto.getIsNews(),
                ...
                reqDto.getIsSports(),
                reqDto.getIsNew(),
                reqDto.getIsPremiere(),
                reqDto.getIsNewOrPremiere(),
                reqDto.getIsRepeat(),
                reqDto.getProjectToMedia(),
                reqDto.getMediaTypes(),
                reqDto.getImageTypes(),
                reqDto.getSortBy(),
                reqDto.getIsPlayed(),
                reqDto.getGenres(),
                reqDto.getOfficialRatings(),
                reqDto.getTags(),
                reqDto.getExcludeTags(),
                reqDto.getYears(),
                reqDto.getEnableImages(),
                reqDto.getEnableUserData(),
                reqDto.getImageTypeLimit(),
                reqDto.getEnableImageTypes(),
                reqDto.getPerson(),
                reqDto.getPersonIds(),
                reqDto.getPersonTypes(),
                reqDto.getStudios(),
                reqDto.getStudioIds(),
                reqDto.getArtists(),
                reqDto.getArtistIds(),
                reqDto.getAlbums(),
                reqDto.getIds(),
                reqDto.getVideoTypes(),
                reqDto.getContainers(),
                reqDto.getAudioCodecs(),
                reqDto.getAudioLayouts(),
                reqDto.getVideoCodecs(),
                reqDto.getExtendedVideoTypes(),
                reqDto.getSubtitleCodecs(),
                reqDto.getPath(),
                reqDto.getUserId(),
                reqDto.getMinOfficialRating(),
                reqDto.getIsLocked(),
                reqDto.getIsPlaceHolder(),
                reqDto.getHasOfficialRating(),
                reqDto.getGroupItemsIntoCollections(),
                reqDto.getIs3D(),
                reqDto.getSeriesStatus(),
                reqDto.getNameStartsWithOrGreater(),
                reqDto.getArtistStartsWithOrGreater(),
                reqDto.getAlbumArtistStartsWithOrGreater(),
                reqDto.getNameStartsWith(),
                reqDto.getNameLessThan(),
                null,
                null);
        Type localVarReturnType = new TypeToken<QueryResultBaseItemRespDto>() {
        }.getType();
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Browsing-the-Library.html">Gets items based on a query. Documentation</a>
     */
    public ApiResponse<QueryResultBaseItemRespDto> getUsersByUseridItemsWithHttpInfo(String userId, String artistType, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer minIndexNumber, String minStartDate, String maxStartDate, String minEndDate, String maxEndDate, Integer minPlayers, Integer maxPlayers, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHD, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, Integer airedDuringSeason, String minPremiereDate, String minDateLastSaved, String minDateLastSavedForUser, String maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, String excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, String parentId, String fields, String excludeItemTypes, String includeItemTypes, String anyProviderIdEquals, String filters, Boolean isFavorite, Boolean isMovie, Boolean isSeries, Boolean isFolder, Boolean isNews, Boolean isKids, Boolean isSports, Boolean isNew, Boolean isPremiere, Boolean isNewOrPremiere, Boolean isRepeat, Boolean projectToMedia, String mediaTypes, String imageTypes, String sortBy, Boolean isPlayed, String genres, String officialRatings, String tags, String excludeTags, String years, Boolean enableImages, Boolean enableUserData, Integer imageTypeLimit, String enableImageTypes, String person, String personIds, String personTypes, String studios, String studioIds, String artists, String artistIds, String albums, String ids, String videoTypes, String containers, String audioCodecs, String audioLayouts, String videoCodecs, String extendedVideoTypes, String subtitleCodecs, String path, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean groupItemsIntoCollections, Boolean is3D, String seriesStatus, String nameStartsWithOrGreater, String artistStartsWithOrGreater, String albumArtistStartsWithOrGreater, String nameStartsWith, String nameLessThan) throws ApiException {
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Item-Information.html">Gets items based on a query. Documentation</a>
     */
    public QueryResultBaseItemRespDto getUsersByUseridItemsResume(String userId, String artistType, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer minIndexNumber, String minStartDate, String maxStartDate, String minEndDate, String maxEndDate, Integer minPlayers, Integer maxPlayers, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHD, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, Integer airedDuringSeason, String minPremiereDate, String minDateLastSaved, String minDateLastSavedForUser, String maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, String excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, String parentId, String fields, String excludeItemTypes, String includeItemTypes, String anyProviderIdEquals, String filters, Boolean isFavorite, Boolean isMovie, Boolean isSeries, Boolean isFolder, Boolean isNews, Boolean isKids, Boolean isSports, Boolean isNew, Boolean isPremiere, Boolean isNewOrPremiere, Boolean isRepeat, Boolean projectToMedia, String mediaTypes, String imageTypes, String sortBy, Boolean isPlayed, String genres, String officialRatings, String tags, String excludeTags, String years, Boolean enableImages, Boolean enableUserData, Integer imageTypeLimit, String enableImageTypes, String person, String personIds, String personTypes, String studios, String studioIds, String artists, String artistIds, String albums, String ids, String videoTypes, String containers, String audioCodecs, String audioLayouts, String videoCodecs, String extendedVideoTypes, String subtitleCodecs, String path, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean groupItemsIntoCollections, Boolean is3D, String seriesStatus, String nameStartsWithOrGreater, String artistStartsWithOrGreater, String albumArtistStartsWithOrGreater, String nameStartsWith, String nameLessThan) throws ApiException {
        ApiResponse<QueryResultBaseItemRespDto> resp = getUsersByUseridItemsResumeWithHttpInfo(userId, artistType, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, minIndexNumber, minStartDate, maxStartDate, minEndDate, maxEndDate, minPlayers, maxPlayers, parentIndexNumber, hasParentalRating, isHD, isUnaired, minCommunityRating, minCriticRating, airedDuringSeason, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, anyProviderIdEquals, filters, isFavorite, isMovie, isSeries, isFolder, isNews, isKids, isSports, isNew, isPremiere, isNewOrPremiere, isRepeat, projectToMedia, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, excludeTags, years, enableImages, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, studioIds, artists, artistIds, albums, ids, videoTypes, containers, audioCodecs, audioLayouts, videoCodecs, extendedVideoTypes, subtitleCodecs, path, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, groupItemsIntoCollections, is3D, seriesStatus, nameStartsWithOrGreater, artistStartsWithOrGreater, albumArtistStartsWithOrGreater, nameStartsWith, nameLessThan);
        return resp.getData();
    }
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Item-Information.html">Gets items based on a query. Documentation</a>
     */
    public ApiResponse<QueryResultBaseItemRespDto> getUsersByUseridItemsResumeWithHttpInfo(String userId, String artistType, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, String adjacentTo, Integer minIndexNumber, String minStartDate, String maxStartDate, String minEndDate, String maxEndDate, Integer minPlayers, Integer maxPlayers, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHD, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, Integer airedDuringSeason, String minPremiereDate, String minDateLastSaved, String minDateLastSavedForUser, String maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, String excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, String parentId, String fields, String excludeItemTypes, String includeItemTypes, String anyProviderIdEquals, String filters, Boolean isFavorite, Boolean isMovie, Boolean isSeries, Boolean isFolder, Boolean isNews, Boolean isKids, Boolean isSports, Boolean isNew, Boolean isPremiere, Boolean isNewOrPremiere, Boolean isRepeat, Boolean projectToMedia, String mediaTypes, String imageTypes, String sortBy, Boolean isPlayed, String genres, String officialRatings, String tags, String excludeTags, String years, Boolean enableImages, Boolean enableUserData, Integer imageTypeLimit, String enableImageTypes, String person, String personIds, String personTypes, String studios, String studioIds, String artists, String artistIds, String albums, String ids, String videoTypes, String containers, String audioCodecs, String audioLayouts, String videoCodecs, String extendedVideoTypes, String subtitleCodecs, String path, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean groupItemsIntoCollections, Boolean is3D, String seriesStatus, String nameStartsWithOrGreater, String artistStartsWithOrGreater, String albumArtistStartsWithOrGreater, String nameStartsWith, String nameLessThan) throws ApiException {
